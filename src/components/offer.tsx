...
const Offer = () => {
    return(
        <div className="bg-black h-screen flex flex-1 flex-col md:flex-row md:justify-between md:bg-[url('/offerBg.png')] md:h-[70vh]">
            {/* TEXT CONTAINER */}
            <div className="flex-1 flex flex-col items-center justify-center text-center gap-8 p-6">
                <h1 className="text-white text-2xl font-bold xl:text-6xl">Delicious Burger & French Fry</h1>
